  ...
  return (
    <Card className="animate-fade-in">
      <CardHeader>
        ...
        <CardDescription>
          Compare a performance de keywords entre o TecMundo e concorrentes para
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <ComparisonChart
            title="TecMundo > Concorrentes"
            data={MOCK_KEYWORD_COMPARISON_STRONG}
          />
          <ComparisonChart
            title="Concorrentes > TecMundo"
            data={MOCK_KEYWORD_COMPARISON_WEAK}
          />
        </div>
      </CardContent>
    </Card>
